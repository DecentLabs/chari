...
const CopyIcon = () => {
  return (
  <div style={{height:20, width: 20, verticalAlign: 'middle', margin: 10}}>
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 488.3 488.3" style={{enableBackground:'new 0 0 488.3 488.3'}}>
  		<g fill="#02DB96">
  			<path
